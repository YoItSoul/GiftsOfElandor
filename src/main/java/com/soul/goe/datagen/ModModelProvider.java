...
public class ModModelProvider extends ModelProvider {
    ...
    protected void registerModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ...
        blockModels.blockStateOutput.accept(MultiVariantGenerator.multiVariant(ModBlocks.DARKENED_COPPER_BLOCK.get()));
        blockModels.blockStateOutput.accept(MultiVariantGenerator.multiVariant(ModBlocks.ASH_BLOCK.get()));
        ...
        itemModels.generateFlatItem(ModItems.DARKENED_COPPER_INGOT.get(), ModelTemplates.FLAT_ITEM);
        itemModels.generateFlatItem(ModItems.WAND.get(), ModelTemplates.FLAT_ITEM);
        ...
        itemModels.generateFlatItem(ModItems.MINING_FORCE_SPELL.get(), ModelTemplates.FLAT_ITEM);

        //itemModels.generateFlatItem(ModItems.MAGNET_SPELL.get(), ModelTemplates.FLAT_ITEM);
