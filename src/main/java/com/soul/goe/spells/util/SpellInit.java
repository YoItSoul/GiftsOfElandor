...
import com.soul.goe.spells.types.projectiles.*;
import com.soul.goe.spells.types.self.FlySpell;
import com.soul.goe.spells.types.self.LevitateSpell;
import com.soul.goe.spells.types.self.LungeSpell;
import com.soul.goe.spells.types.summons.ArcSpriteSpell;
import com.soul.goe.spells.types.summons.DragonSpriteSpell;
import com.soul.goe.spells.types.summons.FlameSpriteSpell;
import com.soul.goe.spells.types.summons.FrostSpriteSpell;
...
public class SpellInit {
    public static void registerSpells() {
        ...
        SpellRegistry.registerSpell(new SpellData(
                ...
                180,
                SpellCost.builder()
                        .addCost(Items.REDSTONE, 1)
                        .addCost(Items.IRON_NUGGET, 2)
