...
public final class Config {
    ...
    private static final List<String> DEFAULT_PEDESTAL_RECIPES = List.of(
            ...
            "firebolt_spell=minecraft:book|goe:salis_mundus,minecraft:coal->goe:firebolt_spell:1",
            "ray_of_frost_spell=minecraft:book|goe:salis_mundus,minecraft:snowball->goe:ray_of_frost_spell:1",
            "shocking_grasp_spell=minecraft:book|goe:salis_mundus,minecraft:copper_ingot->goe:shocking_grasp_spell:1",
            "magic_missile_spell=minecraft:book|goe:salis_mundus,minecraft:arrow->goe:magic_missile_spell:1",
            "lunge_spell=minecraft:book|goe:salis_mundus,minecraft:feather,minecraft:sugar->goe:lunge_spell:1",
            "levitate_spell=minecraft:book|goe:salis_mundus,minecraft:feather,minecraft:string,minecraft:slime_ball->goe:levitate_spell:1",
            "fireball_spell=minecraft:book|goe:salis_mundus,minecraft:coal,minecraft:gunpowder,minecraft:blaze_powder,minecraft:redstone->goe:fireball_spell:1",
            "lightning_bolt_spell=minecraft:book|goe:salis_mundus,minecraft:copper_ingot,minecraft:iron_ingot,minecraft:redstone,minecraft:quartz->goe:lightning_bolt_spell:1",
            "fly_spell=minecraft:book|goe:salis_mundus,minecraft:feather,minecraft:string,minecraft:slime_ball,minecraft:glowstone_dust,minecraft:ender_pearl->goe:fly_spell:1",
            "frost_sprite_spell=minecraft:book|goe:salis_mundus,minecraft:snowball,minecraft:ice,minecraft:soul_sand,minecraft:glowstone_dust->goe:frost_sprite_spell:1",
            "cone_of_cold_spell=minecraft:book|goe:salis_mundus,minecraft:snowball,minecraft:ice,minecraft:packed_ice,minecraft:lapis_lazuli,minecraft:quartz,minecraft:prismarine_shard->goe:cone_of_cold_spell:1"
    );
