...
public final class Config {
    ...
    private static List<String> getDefaultPedestalRecipes() {
        return List.of(
                ...
                "darkened_copper_block=minecraft:copper_block|goe:ash,goe:ash,goe:ash,goe:ash,goe:ash,goe:ash,goe:ash,goe:ash->goe:darkened_copper_block:1",
                ...
                "mining_force_spell=minecraft:book|goe:salis_mundus,minecraft:netherite_pickaxe,minecraft:diamond_pickaxe,minecraft:golden_pickaxe,minecraft:iron_pickaxe,minecraft:stone_pickaxe,minecraft:wooden_pickaxe->goe:mining_force_spell:1",
                "darkened_copper_block=minecraft:copper_block|goe:ash_block,goe:ash_block,goe:ash_block,goe:ash_block->goe:darkened_copper_block:1"
        );
    }
